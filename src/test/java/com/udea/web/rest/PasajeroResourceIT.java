...
class PasajeroResourceIT {
    ...
    private static final LocalDate UPDATED_FECHA_NACIMIENTO = LocalDate.parse("2026-09-22");
    ...
    void partialUpdatePasajeroWithPatch() throws Exception {
        ...
        partialUpdatedPasajero.apellido(UPDATED_APELLIDO).telefono(UPDATED_TELEFONO).fechaNacimiento(UPDATED_FECHA_NACIMIENTO);
