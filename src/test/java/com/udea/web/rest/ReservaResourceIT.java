...
class ReservaResourceIT {
    ...
    private static final Instant UPDATED_FECHA_RESERVA = Instant.ofEpochMilli(1790094377183L);
    ...
    void partialUpdateReservaWithPatch() throws Exception {
        ...
        partialUpdatedReserva.codigo(UPDATED_CODIGO).estado(UPDATED_ESTADO);
