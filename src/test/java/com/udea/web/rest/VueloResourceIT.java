...
class VueloResourceIT {
    ...
    private static final Instant UPDATED_FECHA_SALIDA = Instant.ofEpochMilli(1790094377183L);

    private static final Instant DEFAULT_FECHA_LLEGADA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_FECHA_LLEGADA = Instant.ofEpochMilli(1790094377183L);
    ...
    void partialUpdateVueloWithPatch() throws Exception {
        ...
        partialUpdatedVuelo.numeroVuelo(UPDATED_NUMERO_VUELO);
