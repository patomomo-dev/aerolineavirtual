      ...
      <div className="table-responsive">
        {asientoList?.length > 0 ? (
          <Table responsive>
            ...
            <tbody>
              {asientoList.map(asiento => (
                <tr key={`entity-${asiento.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/asiento/${asiento.id}`} variant="link" size="sm">
                      {asiento.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button as={Link as any} to={`/asiento/${asiento.id}`} variant="info" size="sm" data-cy="entityDetailsButton">
                      ...
                      <Button
                        onClick={() =>
                          (globalThis.location.href = `/asiento/${asiento.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        variant="danger"
                        size="sm"
